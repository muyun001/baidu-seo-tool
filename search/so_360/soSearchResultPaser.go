...
// 判断是否是主页
//func (sosi *SoSearchResult) IsHomePage() bool {
//	domain := ""
//	if sosi.DisplayUrl != "" && !strings.Contains(sosi.DisplayUrl, "...") {
//		if strings.Index(sosi.DisplayUrl, "http") >= 0 {
//			domain, _ = baidu.GetDomain(sosi.DisplayUrl)
//		} else {
//			domain, _ = baidu.GetDomain("http://" + sosi.DisplayUrl)
//		}
//	} else {
//		if strings.Contains(sosi.DisplayUrl, "...") {
//			if strings.Contains(sosi.DisplayUrl, "?") {
//				return false
//			}
//			td := strings.Replace(sosi.DisplayUrl, "//", "", -1)
...
//		_ = sosi.GetSoRealUrl()
//		if sosi.RealUrl != "" {
//			domain, _ = baidu.GetDomain(sosi.RealUrl)
//		}
//	}
//	if sosi.RealUrl != "" {
//		return strings.HasSuffix(strings.Replace(sosi.RealUrl, "/", "", -1), domain)
//	} else if sosi.DisplayUrl != "" {
//		return strings.HasSuffix(strings.Replace(sosi.DisplayUrl, "/", "", -1), domain)
//	}
//
//	return false
//}
